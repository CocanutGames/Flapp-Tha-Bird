...
class GameplayScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if nodeAtPoint(location).name == "Retry" {
                // restart the game
            ...
            if nodeAtPoint(location).name == "Quit" {
                ...
                self.view?.presentScene(mainMenu!, transition: SKTransition.doorwayWithDuration(NSTimeInterval(1)));
            }
...
//            ground.physicsBody?.contactTestBitMask = ColliderType.Bird;
    ...
    func createPipes() {
        ...
        pipesHolder.position.y = CGFloat.randomBetweenNumbers(-300, secondNum: 300);
        ...
        let move = SKAction.moveToX(-destination, duration: NSTimeInterval(10));
        let remove = SKAction.removeFromParent();
        
        pipesHolder.runAction(SKAction.sequence([move, remove]), withKey: "Move");
